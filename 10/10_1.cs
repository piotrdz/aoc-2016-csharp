...
public class AOC10_1
{
    ...
    static Bot FindBotComparing(SimulationState simulationState, int ChipNumber1, int ChipNumber2)
    {
        return simulationState.Bots.Find(b => b.ChipNumbers.Contains(ChipNumber1) && b.ChipNumbers.Contains(ChipNumber2));
    }
    ...
    public static void Main()
    {
        ...
        Bot bot = FindBotComparing(simulationState, 61, 17);
        Console.WriteLine(bot.Number.ToString());
    }
}
